...
pub(crate) struct ConsumerService {
    ...
    pub(super) consumer: Arc<StreamConsumer>,
    pub(super) completed: CompletedEvents,
    pub(super) delivery: DeliveryService,
}
...
pub(super) fn safe_kafka_error(error: &KafkaError) -> String {
...
pub(super) fn consumer_config(config: &KafkaConfig, client_id: &str) -> ClientConfig {
